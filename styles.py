...
def create_style(
    name: str, base_style: str = "Normal", style_type: str = WD_STYLE_TYPE.PARAGRAPH
) -> None:
...
# Title style
title_style = create_style("Title")
apply_font_format(title_style, name=FONTS["heading"], size=SIZES["title"], bold=True)
apply_paragraph_format(
    title_style, alignment=WD_ALIGN_PARAGRAPH.CENTER, space_after=Pt(24)
)

# Subtitle style
subtitle_style = create_style("Subtitle")
apply_font_format(
...
for level in range(1, 4):
    ...
    apply_font_format(
        heading_style, name=FONTS["heading"], size=SIZES[f"heading{level}"], bold=True
    )
...
# Abstract style
abstract_style = create_style("Abstract")
...
# References style
references_style = create_style("References")
...
# Quote style
quote_style = create_style("Quote")
apply_font_format(quote_style, name=FONTS["serif"], size=SIZES["normal"], italic=True)
apply_paragraph_format(
    quote_style,
    left_indent=Pt(36),
    right_indent=Pt(36),
...
# List styles
list_bullet_style = create_style("List Bullet")
apply_font_format(list_bullet_style, name=FONTS["serif"], size=SIZES["normal"])
apply_paragraph_format(list_bullet_style, left_indent=Pt(36), first_line_indent=Pt(-18))

list_number_style = create_style("List Number")
apply_font_format(list_number_style, name=FONTS["serif"], size=SIZES["normal"])
apply_paragraph_format(list_number_style, left_indent=Pt(36), first_line_indent=Pt(-18))

# Table styles
table_style = create_style("Table Grid", style_type=WD_STYLE_TYPE.TABLE)
...
# Caption style
caption_style = create_style("Caption")
apply_font_format(caption_style, name=FONTS["serif"], size=SIZES["small"], italic=True)
apply_paragraph_format(
    caption_style,
...
# Footnote style
footnote_style = create_style("Footnote")
apply_font_format(footnote_style, name=FONTS["serif"], size=SIZES["tiny"])
apply_paragraph_format(footnote_style, left_indent=Pt(36), first_line_indent=Pt(-18))

# Header style
header_style = create_style("Header")
...
# Footer style
footer_style = create_style("Footer")
...
# Warning style
warning_style = create_style("Warning")
...
# Error style
error_style = create_style("Error")
...
# Success style
success_style = create_style("Success")
...
hidden_style = create_style("Hidden")
